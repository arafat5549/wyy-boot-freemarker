...
import com.jqmkj.java.modules.gen.domain.xml.GenCategory;
...
import com.jqmkj.java.util.base.FreeMarkers;
import com.jqmkj.java.util.config.SystemConfig;
import com.jqmkj.java.util.mapper.JaxbMapper;
...
import com.jqmkj.java.vo.gen.GenTemplateVo;
...
//			}
    ...
    public static String generateToFile(GenTemplateVo tpl, Map<String, Object> model, boolean replaceFile) {
        ...
        String realFileName = FreeMarkers.renderString(tpl.getFileName(), model),
            fileName = StringUtil.getProjectPath(realFileName, DictUtil.getCodeItemVal("sys_gen_code_ui_path")) + File.separator
            + StringUtil.replaceEach(FreeMarkers.renderString(tpl.getFilePath() + "/", model), new String[]{"//", "/", "."},
                new String[]{File.separator, File.separator, File.separator})
            + realFileName;

        logger.debug(" fileName === " + fileName+",getFilePath= "+tpl.getFilePath()+
            ",s="+StringUtil.getProjectPath(realFileName, DictUtil.getCodeItemVal("sys_gen_code_ui_path"))+
...
//			e.printStackTrace();
//		}
        String realFileName ="A.java";
        String sname = StringUtil.getProjectPath(realFileName, DictUtil.getCodeItemVal("sys_gen_code_ui_path"));
