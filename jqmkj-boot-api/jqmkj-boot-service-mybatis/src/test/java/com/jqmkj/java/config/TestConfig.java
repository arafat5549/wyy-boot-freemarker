...
import com.jqmkj.java.common.persistence.handler.EntityMetaObjectHandler;
import com.jqmkj.java.common.persistence.injector.EntityMetaSqlInjector;
 ...
 */
@Configuration
@ComponentScan({"com.jqmkj.java.*"})
@EnableTransactionManagement
@MapperScan("com.jqmkj.java.modules.*.repository")
