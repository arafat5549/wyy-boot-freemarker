...
import com.jqmkj.java.util.domain.DictVm;
...
/**
 * 数据字典工具类 copyright 2014 jqmkj all right reserved author somewhere created on
...
public class DictUtil {
    ...
    private static boolean cluster = jqmkjProperties.getCluster();
