...
/**
 * Copyright 2013 jqmkj All right reserved Author lijie Created on 2013-10-23 下午5:44:04
 *
 * @author wyy
 */
@Controller
@RequestMapping(value = "${jqmkj.adminPath}/sys")
public class SystemResource extends BaseResource {

    public SystemResource() {
        log.warn(PublicUtil.toAppendStr(
            "Jqmkj_Boot Web [", SystemConfig.get("version"), "] 框架开发版权所有 Copyright(c) 2015-2017\n未经授权非法复制,使用,传播,销售,本公司必究法律责任"
        ));
    }
