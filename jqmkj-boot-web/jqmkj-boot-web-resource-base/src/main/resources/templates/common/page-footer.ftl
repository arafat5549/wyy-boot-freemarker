...
<script src="${ctxStatic}/common/jqmkj.js" type="text/javascript"></script>

<script src="${ctxStatic}/common/jqmkj.form.component.js" type="text/javascript"></script>
...
<!-- START THIRD PLUGINS -->
<script src="${ctxStatic}/plugins/wdScrollTab/js/TabPanel.js" type="text/javascript"></script>
<script src="${ctxStatic}/plugins/wdScrollTab/js/TabPanel.extend.js" type="text/javascript"></script>
<!-- END THIRD PLUGINS -->
<script>
    var tabpanel;
    var jcTabs = [
