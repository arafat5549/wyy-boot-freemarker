        ...
        <form id="genTable-form" action="${ctx}/gen/genTable/edit" method="post"
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                    <@jqmkj.form name="parentTable" cssClass="" value="${(genTableVo.parentTable)! }" data="${(tableList)!}" boxType="select" > </@jqmkj.form>
                    </div>
                    <label class="col-md-1 control-label treeRoleOrgBox">当前表外键</label>
                    <div class="col-md-3 treeRoleOrgBox">
                    <@jqmkj.form name="parentTableFk" cssClass="" value="${(genTableVo.parentTableFk)! }" data="${(columnList)!}" boxType="select" > </@jqmkj.form>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">状态<span class="required">*</span></label>
                    <div class="col-md-5">
                    <@jqmkj.form name="status" cssClass="required" boxType="radio" dictCode="sys_status" value="${(genTableVo.status)! }"> </@jqmkj.form>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <table id="contentTable" class="table table-striped table-bordered table-condensed">
                        ...
                        <tr<#if column.status == -1> class="error" title="已删除的列，保存之后消失！"</#if>>
                            ...
                            <td>
                                <@jqmkj.form name="columnFormList[${(column_index)!}].javaType" value="${(column.javaType)!}" cssClass="required input-mini" data="${(javaTypeList)!}" boxType="select" > </@jqmkj.form>
                            </td>
                            <td>
                            ...
                            <td>
                                <@jqmkj.form name="columnFormList[${(column_index)!}].queryType" value="${(column.queryType)!}" cssClass="required input-mini" data="${(queryTypeList)!}" boxType="select" > </@jqmkj.form>
                            </td>
                            <td>
                                <@jqmkj.form name="columnFormList[${(column_index)!}].showType" value="${(column.showType)!}" cssClass="required" data="${(showTypeList)!}" boxType="select" > </@jqmkj.form>
                            </td>
                            <td>
