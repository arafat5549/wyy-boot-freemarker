        ...
        <form id="ajax_form" action="${ctx}/gen/genScheme/edit" method="post"
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5"><@jqmkj.form name="category"
                    cssClass="required" boxType="select" data="${(categoryList)!}"
                    value="${(genSchemeVo.category)! }"> </@jqmkj.form>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input name="packageName" type="text" value="${(genSchemeVo.packageName)! }"
                            ...
                            class="help-inline">建议模块包：com.jqmkj.modules.模块名</span>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">页面数据加载方式<span
                            class="required">*</span></label>
                    <div class="col-md-5">
                    <@jqmkj.form name="viewType"
                    cssClass="required" boxType="select" data="${(viewTypeList)!}"
                    value="${(genSchemeVo.viewType)! }"> </@jqmkj.form>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label">业务表名<span
                            class="required">*</span></label>
                    <div class="col-md-5">
                    <@jqmkj.form name="genTableId"
                    cssClass="required" boxType="select" data="${(tableList)!}"
                    value="${(genSchemeVo.genTableId)! }"> </@jqmkj.form>
                ...
                <div id="parentModule_div" class="form-group hided">
                    ...
                    <div class="col-md-5">
                    <@jqmkj.treeSelect id="module" cssClass="" allowClear="true" name="parentModuleId" labelName="parentModuleName"
                    title="选择模块" url="${ctx}/sys/module/findTreeData?all&type=menu"> </@jqmkj.treeSelect>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">状态<span
                            class="required">*</span></label>
                    <div class="col-md-5"><@jqmkj.form name="status"
                    cssClass="required" boxType="radio" dictCode="sys_status"
                    value="${(genSchemeVo.status)! }"> </@jqmkj.form></div>
                </div>
                <div class="form-group">
