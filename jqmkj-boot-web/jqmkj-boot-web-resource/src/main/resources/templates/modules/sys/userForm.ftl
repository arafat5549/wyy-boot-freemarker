        ...
        <form id="ajax_form" action="${ctx}/sys/user/edit" method="post"
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <@jqmkj.fileInput name="avatar" value="${(userVo.avatar)!}" cssClass="required" type="image"> </@jqmkj.fileInput>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    value="${(userVo.status)! }"> </@jqmkj.form></div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">角色<span
                            class="required">*</span></label>
                    <div class="col-md-8"><@jqmkj.form name="roleIdList"
                    cssClass="required" data="${allRoles!}" boxType="checkbox"
                    value="${(userVo.roleIds)! }"> </@jqmkj.form></div>
                </div>
                <div class="form-group">
