<div class="row">
    <div class="col-md-2">
    <@jqmkj.treeShow id="dict_" title="字典" selectNodeId="nodeId" url="${ctx}/sys/dict/findTreeData?all"
    clickNodeFn="clickTreeNodeDict" allowCancelSelect="true" cancelClickNodeFn="cancelClickNodeDict" nodesLevel="1"> </@jqmkj.treeShow>
    </div>
    <div class="col-md-10">
...
<script type="text/javascript">
                ...
                dataTable: {
                    ...
                    "columns": [
                        ...
                        {data: "code"}, {data: "key"},
                        {
                            ...
                            return jqmkj.subMaxStr(data, 20);
                        }
    ...
    var nodeId = jqmkj.getUserCookie("tree_dict_select_node_id"), nodeId = (nodeId) ? nodeId : 1,
            addUrl = $("#add-dict").attr("data-url");
    jQuery(document).ready(function () {
        dataTables.init();
    });
    function cancelClickNodeDict(event, treeId, treeNode) {
        jqmkj.setCookie("tree_dict_select_node_id", '');
        $("#parentId").val('');
    ...
    function clickTreeNodeDict(event, treeId, treeNode) {
        nodeId = treeNode.id;
        jqmkj.setCookie("tree_dict_select_node_id", nodeId);
