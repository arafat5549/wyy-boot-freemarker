        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <form class="form-inline form-search" role="form">
                    ...
                    <@jqmkj.form name="status_" analytiColumn="false" searchItem="searchItem" dictCode="sys_status" boxType="checkbox" operate="in" attrType="Integer"> </@jqmkj.form>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <#--<input id="dataFile" name="dataFile" type="file" class="required" />-->
                                <@jqmkj.fileInput name="dataFile" cssClass="required" type="files" options="{
                                autoUpload: false,
                                singleFileUploads: true,
                                url: '${ctx}/sys/user/uploadData',
                                add: fileuploadAdd
                                }"> </@jqmkj.fileInput>
                            <#--<@jqmkj.fileInput name="dataFile1" cssClass="required" type="files" options="{-->
                            <#--}"> </@jqmkj.fileInput>-->
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        $("#downloadUserTemplate").click(function(){
            jqmkj.goTo("${ctx}/sys/user/importTemplate")
        })
