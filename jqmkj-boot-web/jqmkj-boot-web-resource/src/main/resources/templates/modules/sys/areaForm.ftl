            ...
            <form id="ajax_form" action="${ctx}/sys/area/edit" method="post"
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                        <@jqmkj.treeSelect id="area" cssClass="required" allowClear="true" name="parentId" value="${(areaVo.parentId)!}" labelName="parentName"
                        labelValue="${(areaVo.parentName)!}" extId="${(areaVo.id)!}" title="选择上级区域管理" url="${ctx}/sys/area/findTreeData"> </@jqmkj.treeSelect>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                        <@jqmkj.form name="level" dictCode="sys_area_type" cssClass="" boxType="select" value="${(areaVo.level)!}" > </@jqmkj.form>
                        </div>
                    </div>
                    <div class="form-group">
