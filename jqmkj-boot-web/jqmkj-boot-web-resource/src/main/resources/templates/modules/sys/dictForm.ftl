            ...
            <form id="ajax_form" action="${ctx}/sys/dict/edit" method="post"
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                        <@jqmkj.treeSelect id="dict" cssClass="required" allowClear="true" name="parentId" value="${(dictVo.parentId)!}" labelName="parentName"
                        labelValue="${(dictVo.parentName)!}" extId="${(dictVo.id)!}"
                        title="选择字典" url="${ctx}/sys/dict/findTreeData"> </@jqmkj.treeSelect>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                        <@jqmkj.form name="isShow" cssClass="required" boxType="radio" dictCode="sys_yes_no" value="${(dictVo.isShow)! }"> </@jqmkj.form>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                        <@jqmkj.form name="status" cssClass="required" boxType="radio" dictCode="sys_status" value="${(dictVo.status)! }"> </@jqmkj.form>
                        </div>
                    </div>
                    <div class="form-group">
