        ...
        <form id="ajax_form" action="${ctx}/sys/role/edit" method="post"
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                    <@jqmkj.treeSelect id="org" cssClass="input_staff_type" allowClear="true" name="orgId" value="${(roleVo.orgId)!}" labelName="orgName"
                    labelValue="${(roleVo.orgName)!}"
                    title="选择组织" url="${ctx}/sys/org/findTreeData"> </@jqmkj.treeSelect>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                    <@jqmkj.form name="sysData" cssClass="required" boxType="radio" dictCode="sys_yes_no" value="${(roleVo.sysData)! }"> </@jqmkj.form>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">状态<span class="required">*</span></label>
                    <div class="col-md-5">
                    <@jqmkj.form name="status" cssClass="required" boxType="radio" dictCode="sys_status" value="${(roleVo.status)! }"> </@jqmkj.form>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">数据权限<span class="required">*</span></label>
                    <div class="col-md-5">
                    <@jqmkj.form name="dataScope" id="dataScope" cssClass="required" boxType="select" dictCode="sys_role_scope" value="${(roleVo.dataScope)! }"> </@jqmkj.form>
                    </div>
                </div>
