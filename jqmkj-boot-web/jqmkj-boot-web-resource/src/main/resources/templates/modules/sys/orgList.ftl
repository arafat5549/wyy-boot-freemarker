<div class="row">
    <div class="col-md-3">
    <@jqmkj.treeShow id="org_" title="组织机构" selectNodeId="nodeId" url="${ctx}/sys/org/findTreeData?all"
    clickNodeFn="clickTreeNodeOrg" allowCancelSelect="true" cancelClickNodeFn="cancelClickNodeOrg" nodesLevel="3"> </@jqmkj.treeShow>
    </div>
    <div class="col-md-9">
...
<script type="text/javascript">
    ...
    var nodeId = jqmkj.getUserCookie("tree_org_select_node_id"), nodeId = (nodeId) ? nodeId : 1;
    jQuery(document).ready(function () {
        $("#add-org").attr("data-url-temp", $("#add-org").attr("data-url"));
        dataTables.init();
    });
    function cancelClickNodeOrg(event, treeId, treeNode) {
        jqmkj.setCookie("tree_org_select_node_id", '');
        $("#parentId").val('');
    ...
    function clickTreeNodeOrg(event, treeId, treeNode) {
        ...
        nodeId = treeNode.id;
        jqmkj.setCookie("tree_org_select_node_id", nodeId);
