<div class="row">
    <div class="col-md-2">
    <@jqmkj.treeShow id="area_" title="区域管理" selectNodeId="nodeId" url="${ctx}/sys/area/findTreeData?all"
    clickNodeFn="clickTreeNodeArea" allowCancelSelect="true" cancelClickNodeFn="cancelClickNodeArea" nodesLevel="1"> </@jqmkj.treeShow>
    </div>
    <div class="col-md-10">
...
<script type="text/javascript">
    ...
    var nodeId = jqmkj.getUserCookie("tree_area_select_node_id"), nodeId = (nodeId) ? nodeId : 1,
    ...
    function cancelClickNodeArea(event, treeId, treeNode) {
        jqmkj.setCookie("tree_area_select_node_id", '');
        $("#parentId").val('');
    ...
    function clickTreeNodeArea(event, treeId, treeNode) {
        nodeId = treeNode.id;
        jqmkj.setCookie("tree_area_select_node_id", nodeId);
