        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <form class="form-inline form-search" role="form">
                    ...
                    <@jqmkj.form name="levelString" searchItem="searchItem" dictCode="sys_log_level" boxType="checkbox" value="${(loggingEvent.levelString)!}" operate="eq" attrType="String"> </@jqmkj.form>
                    </div>
                    <div class="form-group">
                        <label class="input-label" for="referenceFlag">引用标识</label>
                    <@jqmkj.form name="referenceFlag" searchItem="searchItem" dictCode="sys_yes_no" boxType="checkbox" value="${(loggingEvent.referenceFlag)!}" operate="eq" attrType="String"> </@jqmkj.form>
                    </div>
