            ...
            <form id="ajax_form" action="${ctx}/sys/user/edit" method="post"
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                        <@jqmkj.treeSelect id="org" cssClass="input_staff_type" allowClear="true" name="orgId" value="${(user.orgId)!}" labelName="orgName"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                        <@jqmkj.form name="status" cssClass="required" boxType="checkbox" dictCode="sys_status" value="${(user.status)! }"> </@jqmkj.form>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">角色<span class="required">*</span></label>
                        <div class="col-md-8">
                        <@jqmkj.form name="roleIdList" cssClass="required" data="${allRoles!}" boxType="checkbox" value="${(user.roleIds)! }"> </@jqmkj.form>
                        </div>
                    </div>
                    <div class="form-group">
