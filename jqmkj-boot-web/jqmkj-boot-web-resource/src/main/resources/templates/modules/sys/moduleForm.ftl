            ...
            <form id="ajax_form" action="${ctx}/sys/module/edit" method="post"
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                        <@jqmkj.treeSelect id="module" cssClass="required" allowClear="true" name="parentId" value="${(moduleVo.parentId)!}" labelName="parentName"
                        labelValue="${(moduleVo.parentName)!}" extId="${(moduleVo.id)!}"
                        title="选择模块" url="${ctx}/sys/module/findTreeData"> </@jqmkj.treeSelect>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                        <@jqmkj.form name="type" cssClass="required" boxType="select" dictCode="sys_module_type" value="${(moduleVo.type)! }"> </@jqmkj.form>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                        <@jqmkj.form name="requestMethod" cssClass="" boxType="checkbox" dictCode="sys_request_method" value="${(moduleVo.requestMethod)! }"> </@jqmkj.form>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                        <@jqmkj.form name="status" cssClass="required" boxType="radio" dictCode="sys_status" value="${(moduleVo.status)! }"> </@jqmkj.form>
                        </div>
                    </div>
                    <div class="form-group">
