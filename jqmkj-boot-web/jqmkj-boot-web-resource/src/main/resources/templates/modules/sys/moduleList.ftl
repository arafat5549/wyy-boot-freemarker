<div class="row">
    <div class="col-md-2">
    <@jqmkj.treeShow id="module" title="模块" url="${ctx}/sys/module/findTreeData?all" selectNodeId="nodeId"
    clickNodeFn="clickTreeNodeModule" allowCancelSelect="true" cancelClickNodeFn="cancelClickNodeModule" nodesLevel="3"> </@jqmkj.treeShow>
    </div>
    <div class="col-md-10">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <form class="form-inline form-search" module="form">
                    ...
                    <@jqmkj.form name="type" searchItem="searchItem" dictCode="sys_module_type" boxType="checkbox" operate="in" attrType="Integer"> </@jqmkj.form>
                    </div>
                    <div class="form-group">
                        <label class="input-label">状态</label>
                    <@jqmkj.form name="status" searchItem="searchItem" dictCode="sys_status" boxType="checkbox" operate="in" attrType="Integer"> </@jqmkj.form>
                    </div>
...
<script type="text/javascript">
    ...
    var nodeId = jqmkj.getUserCookie("tree_module_select_node_id"), nodeId = (nodeId) ? nodeId : null,
    ...
    function cancelClickNodeModule(event, treeId, treeNode) {
        jqmkj.setCookie("tree_module_select_node_id", '');
        $("#parentId").val('');
    ...
    function clickTreeNodeModule(event, treeId, treeNode) {
        nodeId = treeNode.id;
        jqmkj.setCookie("tree_module_select_node_id", nodeId);
