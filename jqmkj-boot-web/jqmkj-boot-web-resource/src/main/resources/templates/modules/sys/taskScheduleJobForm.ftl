        ...
        <form id="ajax_form" action="${ctx}/sys/taskScheduleJob/edit" method="post"
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                    <@jqmkj.form name="jobStatus" dictCode="sys_yes_no" cssClass="required" boxType="radio" value="${(taskScheduleJobVo.jobStatus)!}" > </@jqmkj.form>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                    <@jqmkj.form name="isConcurrent" dictCode="sys_yes_no" cssClass="required" boxType="radio" value="${(taskScheduleJobVo.isConcurrent)!}" > </@jqmkj.form>
                    </div>
                </div>
                <div class="form-group">
