            ...
            <form id="ajax_form" action="${ctx}/sys/org/edit" method="post"
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                        <@jqmkj.treeSelect id="org" cssClass="required" allowClear="true" name="parentId" value="${(orgVo.parentId)!}" labelName="parentName"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                        <@jqmkj.form name="type" id="type" cssClass="required" boxType="select" dictCode="sys_org_type" value="${(orgVo.type)! }"> </@jqmkj.form>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">等级<span class="required">*</span></label>
                        <div class="col-md-5">
                        <@jqmkj.form name="grade" id="grade" cssClass="required" boxType="select" dictCode="sys_org_grade" value="${(orgVo.grade)! }"> </@jqmkj.form>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                        <@jqmkj.form name="status" cssClass="required" boxType="radio" dictCode="sys_status" value="${(orgVo.status)! }"> </@jqmkj.form>
                        </div>
                    </div>
                    <div class="form-group">
