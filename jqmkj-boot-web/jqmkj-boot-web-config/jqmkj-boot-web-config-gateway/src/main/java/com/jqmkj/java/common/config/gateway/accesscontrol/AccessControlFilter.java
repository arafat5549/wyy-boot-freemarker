package com.jqmkj.java.common.config.gateway.accesscontrol;
...
public class AccessControlFilter extends ZuulFilter {
    ...
    public AccessControlFilter(RouteLocator routeLocator, JqmkjProperties jqmkjProperties) {
    ...
    private boolean isAuthorizedRequest(String serviceUrl, String serviceName, String requestUri) {
        Map<String, List<String>> authorizedMicroservicesEndpoints = jqmkjProperties.getGateway()
