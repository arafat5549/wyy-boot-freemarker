package com.jqmkj.java.common.config.gateway.ratelimiting;
...
public class RateLimitingFilter extends ZuulFilter {
    ...
    public RateLimitingFilter(JqmkjProperties jqmkjProperties) {
    ...
    private Supplier<BucketConfiguration> getConfigSupplier() {
        return () -> {
            JqmkjProperties.Gateway.RateLimiting rateLimitingProperties =
                jqmkjProperties.getGateway().getRateLimiting();
