//package com.jqmkj.java.config;
//
//import com.jqmkj.java.common.config.JqmkjProperties;
//import com.jqmkj.java.common.config.WebConfigurer;
...
//        assertThat(container.getMimeMappings().get("abs")).isEqualTo("audio/plugins.ligerui-mpeg");
...
//        props.getHttp().setVersion(JqmkjProperties.Http.Version.V_2_0);
//        UndertowEmbeddedServletContainerFactory container = new UndertowEmbeddedServletContainerFactory();
//        webConfigurer.customize(container);
//        Builder builder = Undertow.builder();
//        container.getBuilderCustomizers().forEach(c -> c.customize(builder));
