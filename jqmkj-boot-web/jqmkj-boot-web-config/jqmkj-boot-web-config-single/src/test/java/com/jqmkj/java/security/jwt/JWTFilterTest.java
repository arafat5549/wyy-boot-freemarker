package com.jqmkj.java.security.jwt;
...
import com.jqmkj.java.common.security.jwt.JWTFilter;
...
public class JWTFilterTest {
    ...
    @Before
    public void setup() {
        JqmkjProperties jqmkjProperties = new JqmkjProperties();
        jqmkjProperties.getHttp().setRestful(true);
        tokenProvider = new TokenProvider(jqmkjProperties);
        ReflectionTestUtils.setField(tokenProvider, "secretKey", "test secret");
        ReflectionTestUtils.setField(tokenProvider, "tokenValidityInMilliseconds", 60000);
        jwtFilter = new JWTFilter(tokenProvider, jqmkjProperties);
