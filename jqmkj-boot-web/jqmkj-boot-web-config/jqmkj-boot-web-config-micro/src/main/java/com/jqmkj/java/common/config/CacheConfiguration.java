...
public class CacheConfiguration {
    ...
    @Bean
    public HazelcastInstance hazelcastInstance(JqmkjProperties jqmkjProperties) {
        ...
        config.getMapConfigs().put("com.jqmkj.java.modules.*.domain.*", initializeDomainMapConfig(jqmkjProperties));
    ...
    private MapConfig initializeDomainMapConfig(JqmkjProperties jqmkjProperties) {
        MapConfig mapConfig = new MapConfig();
        mapConfig.setTimeToLiveSeconds(jqmkjProperties.getCache().getHazelcast().getTimeToLiveSeconds());
        return mapConfig;
    }
}
