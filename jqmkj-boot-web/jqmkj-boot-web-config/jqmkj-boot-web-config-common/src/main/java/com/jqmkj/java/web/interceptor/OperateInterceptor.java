package com.jqmkj.java.web.interceptor;
...
import com.jqmkj.java.util.annotation.ParamNotNull;
...
public class OperateInterceptor implements HandlerInterceptor {
    ...
    public static final String TOKEN_NAME = "Jqmkj-Requst-Token";
    ...
    public OperateInterceptor(JqmkjProperties jqmkjProperties) {
        isTokenInterceptor = jqmkjProperties.getIsTokenInterceptor();
        freeURL = jqmkjProperties.getFreeURL();
    }
    ...
    public void writeUrl(HttpServletRequest request, HttpServletResponse response, String url) throws Exception {
        ...
        response.setCharacterEncoding("UTF-8");
        StringBuffer path = new StringBuffer("<script> window.top.location.href='").append(request.getScheme()).append("://")
