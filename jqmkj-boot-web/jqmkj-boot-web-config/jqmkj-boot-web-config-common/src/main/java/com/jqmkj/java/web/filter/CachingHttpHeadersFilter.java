...
public class CachingHttpHeadersFilter implements Filter {
    ...
    public CachingHttpHeadersFilter(JqmkjProperties jqmkjProperties) {
        this.jqmkjProperties = jqmkjProperties;
    }

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        CACHE_TIME_TO_LIVE = TimeUnit.DAYS.toMillis(jqmkjProperties.getHttp().getCache().getTimeToLiveInDays());
    }
