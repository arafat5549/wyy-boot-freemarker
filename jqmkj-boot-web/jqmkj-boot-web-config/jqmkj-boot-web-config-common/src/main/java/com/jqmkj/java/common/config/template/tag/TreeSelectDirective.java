...
public class TreeSelectDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body)
        ...
        StringBuffer sb = new StringBuffer().append("<div class=\"input-group\"><input id=\"").append(id)
                ...
                .append("\" onclick=\"jqmkjForm.treeSelect($(this), $(this).prev('input._commonTreeId'));\" readonly=\"readonly\" type=\"text\" value=\"")
                ...
                .append("Button\" class=\"btn blue\" type=\"button\" onclick=\"jqmkjForm.treeSelect($(this).parent().prev('input._commonTreeInput'), $(this).parent().prevAll('input._commonTreeId'));\" >选择</button></span></div>");
