...
public class GridSelectDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body)
        ...
        StringBuffer sb = new StringBuffer().append("<div class=\"input-group\"><input id=\"").append(id)
                ...
                .append("\" onclick=\"jqmkjForm.gridSelect($(this), $(this).prev('input._commonGridId'));\" readonly=\"readonly\" type=\"text\" value=\"")
                ...
                .append("Button\" class=\"btn blue\" type=\"button\" onclick=\"jqmkjForm.gridSelect($(this).parent().prev('input._commonGridInput'), $(this).parent().prevAll('input._commonGridId'));\" >选择</button></span></div>");
