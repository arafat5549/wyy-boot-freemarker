package com.jqmkj.java.common.config.template;

import com.jqmkj.java.common.base.BaseInterface;
import com.jqmkj.java.common.config.JqmkjProperties;
import com.jqmkj.java.common.config.template.tag.CustomTags;
...
public class FreeMarkerConfig implements BaseInterface {
    ...
    public void setSharedVariable() {
        ...
        configuration.setSharedVariable("jqmkj", customTags);
        ...
        configuration.setCustomAttribute("adminPath", jqmkjProperties.getAdminPath());
        configuration.setCustomAttribute("application", jqmkjProperties.getApplication());
        try {
            configuration.setSharedVariable("application", jqmkjProperties.getApplication());
