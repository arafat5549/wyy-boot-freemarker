package com.jqmkj.java.common.config.template.tag;
                ...
                if (value.contains(StringUtil.SPLIT_DEFAULT)) {
                    ...
                    for (int i = 0; i < values.length; i++) {
                        ...
                        sb.append("<div class=\"fileinput-exists thumbnail "+(isImg?"thumbnail-img" : "")+" fileinput-preview-div\">")
                            .append(isImg ? ("<img src=\""+jqmkjProperties.getStaticUrlPath(path)+"\" alt=\"\" class=\"fileinput-item scale-img\" />")
                    ...
                    sb.append("<div class=\"fileinput-exists thumbnail "+(isImg?"thumbnail-img" : "")+" fileinput-preview-div\">")
                        .append(isImg ? ("<img src=\""+(PublicUtil.isNotEmpty(path) ? jqmkjProperties.getStaticUrlPath(path) : path)+"\" alt=\"\" class=\"fileinput-item scale-img\" />")
                            :("<span>"+fileName+"</span>")).append("</div>");
                }
            }
            sb.append("</div>");
            ...
            if (PublicUtil.isNotEmpty(value)) {
                if (value.contains(StringUtil.SPLIT_DEFAULT)) {
                    ...
                    for (int i = 0; i < values.length; i++) {
                        ...
                        sb.append("<div class=\"fileinput-exists thumbnail "+(isImg?"thumbnail-img" : "")+" fileinput-preview-div\">")
                            .append(isImg ? ("<img src=\""+jqmkjProperties.getStaticUrlPath(path)
                    ...
                    sb.append("<div class=\"fileinput-exists thumbnail "+(isImg?"thumbnail-img" : "")+" fileinput-preview-div\">")
                        .append(isImg ? ("<img src=\""+(PublicUtil.isNotEmpty(path) ? jqmkjProperties.getStaticUrlPath(path) : path)
