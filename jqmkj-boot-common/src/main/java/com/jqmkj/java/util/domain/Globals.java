package com.jqmkj.java.util.domain;
...
public final class Globals {
    ...
    // Spring profile for development and production, see http://jqmkj.github.io/profiles/
    ...
    public static final String ALBEDO_QUARTZENABLED = "jqmkj.quartzEnabled";
