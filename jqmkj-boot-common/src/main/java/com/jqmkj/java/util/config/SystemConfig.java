package com.jqmkj.java.util.config;
 ...
 * 系统配置类
 *
 * @author wyy version 2014-1-20 下午4:06:33
 */
public class SystemConfig {
    ...
    public static void reload(String path) throws Exception {
        ...
        InputStream is = sc.getClass().getResourceAsStream(PublicUtil.isEmpty(path) ? "/jqmkj.properties" : path);// properties
        // in
        // the
        // classpath
        props.load(is);
    ...
    public static void dumpSystemConfig() {
        ...
        if (props != null) {
            ...
            while (e.hasMoreElements()) {
                ...
                logger.info("jqmkj.properties: " + key + " = " + value);
            }
        }
    }
