...
import com.jqmkj.java.util.annotation.JsonField;
...
public class GenTableVo extends DataEntityVo<String> {
    ...
    public List<String> getImportList() {
        List<String> importList = Lists.newArrayList("com.jqmkj.java.util.PublicUtil",
            "com.baomidou.mybatisplus.annotations.*",
                "com.jqmkj.java.util.annotation.SearchField"); // 引用列表
        if ("treeTable".equalsIgnoreCase(getCategory())) {
            importList.add("com.jqmkj.java.common.persistence.domain.TreeEntity");
            // 如果有子表，则需要导入List相关引用
            ...
            importList.add("com.jqmkj.java.common.persistence.domain.IdEntity");
    ...
    private void initImport(List<String> importList) {
        for (GenTableColumnVo column : getColumnList()) {
            ...
            if (PublicUtil.isNotEmpty(column.getDictType())) {
                addNoRepeatList(importList, "com.jqmkj.java.util.annotation.DictType");
            }
            ...
            if (column.getUnique()) {
                addNoRepeatList(importList, "com.jqmkj.java.util.annotation.SearchField");
            }
        }
    }
