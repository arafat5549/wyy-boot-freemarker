...
jqmkj.searchItemForm = function (grid_selector, formId) {
...
jqmkj.searchJsonItemForm = function (grid_selector, formId) {
...
jqmkj.confirmAjax = function (href, msg, callback) {
    if (!jqmkj.isExitsFunction(callback)) callback = function (data) {
        if (data) {
            if (data.type == "success") $(grid_selector).trigger("reloadGrid");
            jqmkj.g_showMsg(data.msg, data.type);
        }
    }
