...
import com.jqmkj.java.modules.sys.web.FileDataResource;
import com.jqmkj.java.util.Json;
import com.jqmkj.java.util.base.Encodes;
...
import com.jqmkj.java.web.rest.ExceptionTranslator;
import com.jqmkj.java.web.rest.TestUtil;
...
import static com.jqmkj.java.web.rest.TestUtil.createFormattingConversionService;
...
public class FileDataResourceIntTest {
    ...
    public void setup() {
        ...
        DEFAULT_API_URL = jqmkjProperties.getAdminPath("/sys/fileData/");
        ...
        this.restFileDataMockMvc = MockMvcBuilders.standaloneSetup(fileDataResource)
            .addPlaceholderValue("jqmkj.adminPath", jqmkjProperties.getAdminPath())
