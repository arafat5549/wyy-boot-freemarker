...
import com.jqmkj.java.common.config.SchedulerConfiguration;
...
public class JqmkjBootWebApp {

    private static final Logger log = LoggerFactory.getLogger(JqmkjBootWebApp.class);
    ...
    public static void main(String[] args) throws Exception {
        SpringApplication app = new SpringApplication(JqmkjBootWebApp.class);
