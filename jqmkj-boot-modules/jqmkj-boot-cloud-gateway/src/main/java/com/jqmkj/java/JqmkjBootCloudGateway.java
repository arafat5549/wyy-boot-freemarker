...
@EnableZuulProxy
public class JqmkjBootCloudGateway {

    private static final Logger log = LoggerFactory.getLogger(JqmkjBootCloudGateway.class);
    ...
    public static void main(String[] args) throws Exception {
        SpringApplication app = new SpringApplication(JqmkjBootCloudGateway.class);
