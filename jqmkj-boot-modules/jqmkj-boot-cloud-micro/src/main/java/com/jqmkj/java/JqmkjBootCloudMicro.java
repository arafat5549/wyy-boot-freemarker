...
public class JqmkjBootCloudMicro {
    private static final Logger log = LoggerFactory.getLogger(JqmkjBootCloudMicro.class);

    private final Environment env;

    public JqmkjBootCloudMicro(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JqmkjBootCloudMicro.class);
    ...
    /**
     * Initializes JqmkjBootCloudMicro.
     * <p>
     * Spring profiles can be configured with a program arguments --spring.profiles.active=your-active-profile
     * <p>
     * You can find more information on how profiles work with Jqmkj on <a href="https://jqmkj.github.io/profiles/">https://jqmkj.github.io/profiles/</a>.
     */
    @PostConstruct
