...
(function () {
    ...
    MT("inlineMath",
        "[keyword $][number 3][variable-2 plugins.ligerui][tag ^][number 2.45]-[tag \\sqrt][bracket {][tag \\$\\alpha][bracket }] = [number 2][keyword $] other text");

    MT("displayMath",
        "More [keyword $$]\t[variable-2 S][tag ^][variable-2 n][tag \\sum] [variable-2 i][keyword $$] other text");

    MT("mathWithComment",
        "[keyword $][variable-2 plugins.ligerui] [comment % $]",
