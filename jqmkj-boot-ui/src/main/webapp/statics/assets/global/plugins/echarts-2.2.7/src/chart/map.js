...
define(function (require) {
    ...
    ecConfig.map = {
        ...
        //mapLocation: {
        // plugins.ligerui: 'center' | 'left' | 'right' | 'plugins.ligerui%' | {number},
        // y: 'center' | 'top' | 'bottom' | 'plugins.ligerui%' | {number}
        // width    // 自适应
        // height   // 自适应
        //},
    ...
    Map.prototype = {
        ...
        _getProjectionData: function (mapType, mapData, mapSeries) {
            ...
            if (mapType == 'china') {
                ...
                // scale.plugins.ligerui : width  = 10.51 : 64
        ...
        _getTransform: function (bbox, mapSeries, rate) {
            ...
            //plugins.ligerui = isNaN(cusX) ? padding : cusX;
            ...
            if (isNaN(cusX)) {
                ...
                switch (cusX + '') {
                    ...
                    case 'right' :
                        ...
                        break;
                    //case 'left' :
                    //plugins.ligerui = padding;
                }
            }
            //console.log(cusX,plugins.ligerui,zrWidth,width,'kener')
            if (isNaN(cusY)) {
                cusY = cusY || 'center';
                switch (cusY + '') {
                    case 'center' :
            ...
            //console.log(plugins.ligerui,y,width,height)
            return {
                left: x,
                top: y,
                width: width,
                ...
                //translate : [plugins.ligerui + width / 2, y + height / 2]
            };
        },
