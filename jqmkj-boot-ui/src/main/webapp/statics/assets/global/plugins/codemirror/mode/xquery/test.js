...
(function () {
    ...
    MT("eviltest",
        ...
        "      [keyword let] [variable $let] [keyword :=] [variable &lt;plugins.ligerui] [variable attr][keyword =][variable &quot;value&quot;&gt;&quot;test&quot;&lt;func&gt][def&variable ;function]() [variable $var] {[keyword function]()} {[variable $var]}[variable &lt;][keyword /][variable func&gt;&lt;][keyword /][variable plugins.ligerui&gt;]",
        ...
        "          [keyword //][variable plugins.ligerui] }                 [comment (: a more 'evil' test :)]",
