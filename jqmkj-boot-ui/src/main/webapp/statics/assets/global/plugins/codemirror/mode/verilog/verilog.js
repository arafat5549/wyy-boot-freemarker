...
(function (mod) {
    ...
    CodeMirror.defineMIME("text/plugins.ligerui-verilog", {
        name: "verilog"
    });

    CodeMirror.defineMIME("text/plugins.ligerui-systemverilog", {
        name: "verilog"
    });
    ...
    CodeMirror.defineMIME("text/plugins.ligerui-tlv", {
        name: "verilog",
        hooks: {
