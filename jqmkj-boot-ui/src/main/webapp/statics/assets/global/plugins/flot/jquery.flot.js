...
(function ($) {
    ...
    //     element: The jQuery-wrapped HTML div containing the text.
    //     plugins.ligerui: X coordinate at which to draw the text.
    ...
    // @param {string} layer A string of space-separated CSS classes uniquely
    //     identifying the layer containing this text.
    // @param {number} plugins.ligerui X coordinate at which to draw the text.
    ...
    // @param {string} layer A string of space-separated CSS classes uniquely
    //     identifying the layer containing this text.
    // @param {number=} plugins.ligerui X coordinate of the text.
    ...
    function Plot(placeholder, data_, options_, plugins) {
            ...
            options = {
                ...
                series: {
                    ...
                    bars: {
                        show: false,
                        lineWidth: 2, // in pixels
                        barWidth: 1, // in units of the plugins.ligerui axis
                        fill: true,
                        fillColor: null,
        ...
        function parseOptions(opts) {
            ...
            // If no plugins.ligerui/y axis options were provided, create one of each anyway,
        ...
        function canvasToAxisCoords(pos) {
            // return an object with plugins.ligerui/y corresponding to all used axes
            var res = {}, i, axis;
        ...
        function axisToCanvasCoords(pos) {
            // get canvas coords from the first pair of plugins.ligerui/y found in pos
            var res = {}, i, axis, key;
        ...
        function bindEvents() {
            ...
            if (options.grid.hoverable) {
                ...
                // was fixed somewhere around 1.3.plugins.ligerui.  We can return to using
        ...
        function setupTickGeneration(axis) {
            ...
            // heuristic based on the model a*sqrt(plugins.ligerui) fitted to
        ...
        function drawSeriesLines(series) {
            ...
            function plotLineArea(datapoints, axisx, axisy) {
                ...
                while (true) {
                    ...
                    // keep track of the current plugins.ligerui values
                    ...
                    // if the plugins.ligerui value was changed we got a rectangle
                    // to fill
                    if (x1 != x1old) {
