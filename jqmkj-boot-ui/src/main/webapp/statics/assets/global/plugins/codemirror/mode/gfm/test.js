...
(function () {
    ...
    FT("taskList",
        ...
        "[variable-2&formatting&formatting-list&formatting-list-ul - ][property&formatting&formatting-task [plugins.ligerui]]][variable-2  foo]");
    ...
    MT("taskListAsterisk",
        "[variable-2 * []] foo]", // Invalid; must have space or plugins.ligerui between []
        "[variable-2 * [ ]]bar]", // Invalid; must have space after ]
        "[variable-2 * [plugins.ligerui]]hello]", // Invalid; must have space after ]
        "[variable-2 * ][meta [ ]]][variable-2  [world]]]", // Valid; tests reference style links
        "    [variable-3 * ][property [plugins.ligerui]]][variable-3  foo]"); // Valid; can be nested
    ...
    MT("taskListNumber",
        "[variable-2 1. []] foo]", // Invalid; must have space or plugins.ligerui between []
        "[variable-2 2. [ ]]bar]", // Invalid; must have space after ]
        "[variable-2 3. [plugins.ligerui]]hello]", // Invalid; must have space after ]
        "[variable-2 4. ][meta [ ]]][variable-2  [world]]]", // Valid; tests reference style links
        "    [variable-3 1. ][property [plugins.ligerui]]][variable-3  foo]"); // Valid; can be nested
