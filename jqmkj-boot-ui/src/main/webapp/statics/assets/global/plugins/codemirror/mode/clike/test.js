...
(function () {
    var mode = CodeMirror.getMode({indentUnit: 2}, "text/plugins.ligerui-c");
    ...
    MT("indent_switch",
        "[keyword switch] ([variable plugins.ligerui]) {",
        "  [keyword case] [number 10]:",
        "    [keyword return] [number 20];",
        "  [keyword default]:",
        "    [variable printf]([string \"foo %c\"], [variable plugins.ligerui]);",
        "}");
    ...
    MT("double_block",
        "[keyword for] (;;)",
        "  [keyword for] (;;)",
        "    [variable plugins.ligerui][operator ++];",
        "[keyword return];");
})();
