    ...
    var Mapplic = function () {
        ...
        function DevTools() {
            ...
            this.init = function () {
                ...
                this.el.append('plugins.ligerui: ');
                $('<code></code>').addClass('mapplic-coordinates-plugins.ligerui').appendTo(this.el);
                this.el.append(' y: ');
                ...
                $('.mapplic-layer', self.map).on('mousemove', function (e) {
                    ...
                    $('.mapplic-coordinates-plugins.ligerui').text(parseFloat(x).toFixed(4));
