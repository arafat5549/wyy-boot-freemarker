...
(function ($) {
    ...
    Popup.prototype = {
            ...
            this.$form
                ...
                .on({
                    ...
                    rendered: $.proxy(function () {
                         ...
                         **Note:** Bootstrap popover has own `shown` event that now cannot be separated from plugins.ligerui-editable's one.
                         The workaround is to check `arguments.length` that is always `2` for plugins.ligerui-editable.
        ...
        hide: function (reason) {
             ...
             **Note:** Bootstrap popover has own `hidden` event that now cannot be separated from plugins.ligerui-editable's one.
             The workaround is to check `arguments.length` that is always `2` for plugins.ligerui-editable.
    ...
    $.extend(Text.prototype, {
        ...
        renderClear: function () {
            if (this.options.clear) {
                this.$clear = $('<span class="editable-clear-plugins.ligerui"></span>');
...
(function ($) {
    ...
    var Constructor = function (options) {
        ...
        if (!options.select2.tags && options.source) {
            ...
            if (typeof source === 'string') {
                ...
                //check format and convert plugins.ligerui-editable format to select2 format (if needed)
    ...
    $.extend(Constructor.prototype, {
        ...
        /*
         Converts source from plugins.ligerui-editable format: {value: 1, text: "1"} to
