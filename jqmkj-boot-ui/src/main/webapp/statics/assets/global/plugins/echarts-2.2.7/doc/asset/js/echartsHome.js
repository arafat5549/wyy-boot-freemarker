...
$('#head')[0].innerHTML =
    ...
    + '<li><a href="http://echarts.baidu.com/plugins.ligerui/build/echarts-plugins.ligerui-0.2.0.zip"> echarts-plugins.ligerui-0.2.0 </a></li>'
    + '<li class="divider"></li>'
    + (enVersion
...
if ($footer.length) {
    ...
    $footer[0].innerHTML =
        ...
        + '<li><a href="' + (enVersion ? "http://ecomfe.github.io/echarts-plugins.ligerui" : 'http://echarts.baidu.com/plugins.ligerui/doc') + '" target="_blank">ECharts-X</a></li>'
