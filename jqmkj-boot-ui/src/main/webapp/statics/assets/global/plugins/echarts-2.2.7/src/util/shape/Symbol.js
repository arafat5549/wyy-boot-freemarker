...
define(function (require) {
    ...
    Symbol.prototype = {
        ...
        /* 像素模式
         ...
         // bbox取整
         rect = {
         plugins.ligerui : Math.floor(rect.plugins.ligerui),
         y : Math.floor(rect.y),
         width : Math.floor(rect.width),
         height : Math.floor(rect.height)
         };
         var pixels = ctx.getImageData(
         rect.plugins.ligerui * ratio, rect.y * ratio,
         ...
         idx = ((Math.floor(pointList[i][0]) - rect.plugins.ligerui) * ratio
         ...
         ctx.putImageData(pixels, rect.plugins.ligerui * ratio, rect.y * ratio);
