...
var echartsConfig = {
        ...
        chord: {
             ...
             *         target
             *    -1--2--3--4--5-
             *  1| plugins.ligerui  plugins.ligerui  plugins.ligerui  plugins.ligerui  plugins.ligerui
             *  2| plugins.ligerui  plugins.ligerui  plugins.ligerui  plugins.ligerui  plugins.ligerui
             *  3| plugins.ligerui  plugins.ligerui  plugins.ligerui  plugins.ligerui  plugins.ligerui  source
             *  4| plugins.ligerui  plugins.ligerui  plugins.ligerui  plugins.ligerui  plugins.ligerui
             *  5| plugins.ligerui  plugins.ligerui  plugins.ligerui  plugins.ligerui  plugins.ligerui
             *
        ...
        gauge: {
            ...
            title: {
                show: true,
                offsetCenter: [0, '-40%'],       // plugins.ligerui, y，单位px
                textStyle: {       // 其余属性默认使用全局文本样式，详见TEXTSTYLE
                    color: '#333',
                    fontSize: 15
                }
