    ...
    return {
        ...
        initCharts: function () {
            ...
            function getRandomData() {
                ...
                // zip the generated y values with the plugins.ligerui values
                var res = [];
            ...
            function chart2() {
                ...
                $("#chart_2").bind("plothover", function (event, pos, item) {
                    $("#plugins.ligerui").text(pos.x.toFixed(2));
            ...
            function chart3() {
                ...
                plot = $.plot($("#chart_3"), [{
                    data: sin,
                    label: "sin(plugins.ligerui) = -0.00",
                    lines: {
                        lineWidth: 1,
                    },
                    shadowSize: 0
                    ...
                    data: cos,
                    label: "cos(plugins.ligerui) = -0.00",
                    lines: {
                        lineWidth: 1,
                    },
                    shadowSize: 0
                ...
                function updateLegend() {
                    ...
                    for (i = 0; i < dataset.length; ++i) {
                        ...
                        // find the nearest points, plugins.ligerui-wise
