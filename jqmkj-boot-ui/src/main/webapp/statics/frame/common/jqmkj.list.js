...
$(function () {
    ...
    if (jsonVal) {
        ...
        jqmkj.jsonInitSearchFrom(json_data, formId);
    }
    // 表格排序
...
jqmkj.confirmBacthPost = function (href, callback, msg, emptyMsg) {
    ...
    if ($(formId + " input[name='idList']").length > 0) {
        ...
        jqmkj.g_showMsg(emptyMsg ? emptyMsg : "请勾选要批量删除的记录", WRANING);
    }
    return false;
}