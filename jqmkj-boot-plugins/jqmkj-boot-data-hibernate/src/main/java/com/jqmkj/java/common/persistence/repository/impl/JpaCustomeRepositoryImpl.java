...
import com.jqmkj.java.util.domain.*;
import com.jqmkj.java.util.domain.QueryCondition.Operator;
...
public class JpaCustomeRepositoryImpl<T extends GeneralEntity> implements JpaCustomeRepository<T> {
     ...
     * (non-Javadoc)
     *
     * @see com.jqmkj.java.repository.data.support.Itest#getSession()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.jqmkj.java.repository.data.support.Itest#flush()
     */
    @Override
    public void flush() {
        getSession().flush();
     ...
     * (non-Javadoc)
     *
     * @see com.jqmkj.java.repository.data.support.Itest#clear()
     */
    @Override
    public void clear() {
        getSession().clear();
     ...
     *
     * @see com.jqmkj.java.common.persistence.service.impl.IBaseUtilService#
     * clearLevel2Cache()
     */
    /*
     * (non-Javadoc)
	 *
	 * @see com.jqmkj.java.repository.data.support.Itest#createQuery(java.lang.
     ...
     * (non-Javadoc)
     *
     * @see com.jqmkj.java.repository.data.support.Itest#checkByProperty(T)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.jqmkj.java.repository.data.support.Itest#checkByPK(T)
     */
    @Override
    @Transactional(readOnly = true, rollbackFor = Exception.class)
